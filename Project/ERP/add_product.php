    ...
    include "connect.php";
    $page_name = "Product";
    $query = mysqli_query($con,"SELECT * FROM product where parent_id is NULL");
    $querymax = mysqli_query($con,"SELECT max(id) FROM product");
                                ...
                                <form method="post" action"">
                                    <div class="row">
                                            ...
                                            <div class="form-group border-input">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon border-input" style="background-color: #c2c2c2; "><?php 
                                                        $id = $rowmax[0] +1;
                                                        echo $id?></span>
                                                        <input type="text" name= "product" class="form-control border-input" placeholder="Product Name"  style="width:150px">
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="stock" class="form-control border-input" placeholder="Stock" >
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label> <i class="fa fa-barcode"></i> Barcode</label>
                                                    <input type="text" name="barcode"class="form-control border-input" placeholder="barcode" >
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-info btn-fill btn-wd"><i class="fa fa-plus"></i>Add Product</button>
                                        </div>
